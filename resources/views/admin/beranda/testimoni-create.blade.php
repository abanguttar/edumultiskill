        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="text" name="profesi" class="form-control" value="{{ old('profesi') }}">
                    </div>
                    @error('profesi')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <textarea name="ulasan" id="ulasan" class="form-control" cols="30" rows="10">{{ old('ulasan') }}</textarea>
                    </div>
                    @error('ulasan')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
