        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="judul_jadwal_pelatihan"
                            value="{{ old('judul_jadwal_pelatihan', $jadwal->judul_jadwal_pelatihan) }}" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="schedule_code"
                            value="{{ old('schedule_code', $jadwal->schedule_code) }}" required>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <select class="form-select" name="status" required>
                            ...
                            <option value="tidak aktif"
                                {{ old('status', $jadwal->status) == 'tidak aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                            ...
                            <div class="col">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" name="zona_waktu" id="zona_waktu" style="max-width: 100px;">
                                        @php
                                            $zonaWaktu =
                                                strpos($jadwal->waktu_pelaksanaan, 'WITA') !== false
                                                    ? 'WITA'
                                                    : (strpos($jadwal->waktu_pelaksanaan, 'WIT') !== false
                                                        ? 'WIT'
                                                        : 'WIB');
                                        @endphp
                        ...
                        <input type="hidden" name="waktu_pelaksanaan" id="waktu_pelaksanaan"
                            value="{{ $jadwal->waktu_pelaksanaan }}">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="number" class="form-control" name="kuota_max"
                            value="{{ old('kuota_max', $jadwal->kuota_max) }}" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="number" class="form-control" name="kuota"
                            value="{{ old('kuota', $jadwal->kuota) }}" disabled>
                    </div>
                </div>
