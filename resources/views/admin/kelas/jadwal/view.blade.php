...
@section('body')
    ...
    <div class="container-fluid p-4 mt-3 mb-5">
        ...
        <div>
            ...
            <!-- Button Group -->
            <div class="mt-3">
                <a href="{{ route('create-jadwal', $kelas->id) }}" class="btn btn-success btn-sm">
                    <i class="feather-16" data-feather="plus-circle"></i> Tambah
                </a>
                ...
                <button type="button" class="btn btn-info btn-sm text-white" id="btn-archive">
                    <i class="feather-16" data-feather="archive"></i> Arsip
                </button>
            ...
            $('#btn-archive').click(function() {
                ...
                if (selectedRow.any()) {
                    ...
                    Swal.fire({
                        ...
                        text: "Apakah anda yakin ingin mengarsipkan jadwal ini?",
                        icon: 'warning',
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Berhasil',
                                        text: 'Jadwal berhasil diarsipkan'
                                    }).then(() => {
                                        location.reload();
                                    });
                                },
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Peringatan',
                        text: 'Silakan pilih jadwal yang akan diarsipkan'
                    });
                }
            });
