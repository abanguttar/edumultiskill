...
@section('body')
    <div class="container border p-4 mt-3 w-75 mb-5">
        ...
        <div>
            ...
            <!-- Tambah Button Jadwal -->
            <div class="mt-4">
                <a href="{{ route('create-jadwal', $kelas->id) }}" class="btn btn-primary">
                    <i class="feather-16" data-feather="plus-circle"></i> Tambah Jadwal
                </a>
            </div>
        ...
        <!-- Daftar Jadwal -->
                                    ...
                                    <div>
                                        ...
                                        <form action="{{ route('arsip-jadwal', ['id' => $kelas->id, 'jadwal_id' => $j->id]) }}" 
                                            ...
                                            <button type="submit" class="btn btn-info btn-sm"
                                                    onclick="return confirm('Apakah anda yakin ingin mengarsipkan jadwal ini?')">
                                                <i class="feather-16" data-feather="archive"></i> Arsipkan
                                            </button>
                                        </form>
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('view-arsip-jadwal', ['id' => $kelas->id]) }}" 
                class="btn btn-info">
