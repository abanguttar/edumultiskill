                ...
                <div class="accordion" id="accordionSidebar">
                    ...
                    @else
                        <div class="accordion-item mb-1">
                            ...
                            <div id="lms" class="accordion-collapse collapse">
                                <div class="accordion-body">
                                    <a class="nav-link text-dark" data-nav='hasil-pelatihan'
                                        href="/admin/hasil-pelatihan">Hasil Pelatihan</a>
                                    <a class="nav-link text-dark" data-nav='evaluasi-tpm-uk'
                                        href="/admin/evaluasi-tpm-uk">List Evaluasi TPM/UK</a>
                                </div>
                            </div>
                        </div>
                    @endif
